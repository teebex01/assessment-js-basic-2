...
let newStatus=true
class Ticket{
  constructor(items, orderTime, customerId, updateStatus){
    this.items=items,
    ...
    this.updateStatus=function(newStatus){
      ...
      if(newStatus)
      console.log(`the order for ${customerId} is now ${newStatus}`)
    }
}
}
...
let firstTicket=new Ticket(`pizza`,`7:45pm`,640,true )
/*
