...
//CODE HERE
greetUser=(username) => console.log(`welcome back, ${username}`)
greetUser(`toni`) 
...
//CODE HERE
let canWedeliver=true;
let canWeDeliver = (zipCode)=>{
return (canWedeliver && (zipCode===85205|| zipCode===85204 || zipCode===85203 || zipCode===85213 || zipCode===85206) ? `You're in our delivery zone!`:`we are not delivering`)
} 
let x=canWeDeliver(85210)
console.log(x)
...
// CODE HERE
let mat=[]
for(keys in deliveryAreaZipCodes){
  mat.push(deliveryAreaZipCodes[keys])
}
